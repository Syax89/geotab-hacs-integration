...
- **No Hardcoded Secrets:** We never store passwords or tokens in the code.
- **Privacy First:** Sensitive data (like usernames) are hidden from public views in Home Assistant.
- **Rate Limiting:** Built-in checks prevent excessive API calls that could lead to account bans.
- **Regular Audits:** We perform security scans to ensure the project remains robust.
