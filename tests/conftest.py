...
def mock_geotab_api():
    ...
    with patch("mygeotab.API") as mock:
        ...
        instance.multi_call.return_value = [
            ...
            # 2. diag_odometer_adjustment
            [{"device": {"id": "device1"}, "data": 100000, "dateTime": "2026-03-08T10:00:00Z"}],
            # 3. diag_odometer_raw
            [{"device": {"id": "device1"}, "data": 100000, "dateTime": "2026-03-08T10:00:00Z"}],
            # 4. diag_total_distance
            [{"device": {"id": "device1"}, "data": 100000, "dateTime": "2026-03-08T10:00:00Z"}],
            # 5. diag_ignition
